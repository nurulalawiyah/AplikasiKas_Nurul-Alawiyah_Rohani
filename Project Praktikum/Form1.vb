...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            ElseIf ComboBox1.Text = "Keluar" Then
                ...
                End If
            End If
            Dim simpan As String = "insert into tbl_kas values ('" & "','" & DateTimePicker1.Text & "','" & ComboBox1.Text & "','" & TextBox1.Text & "','" & saldoSekarang & "','" &
                TextBox2.Text & "')"
    ...
    Private Sub TextBox2_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox2.KeyPress
        ...
        If e.KeyChar = Chr(13) Then
            bukakoneksi()
            CMD = New OdbcCommand("Select * from tbl_kas where keterangan ='" & TextBox2.Text & "'", CONN)
            RD = CMD.ExecuteReader
            RD.Read()
            If Not RD.HasRows Then
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Else
            If MessageBox.Show("Yakin akan dihapus..? ", "", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) Then
                bukakoneksi()
                Dim hapus As String = "delete from tbl_kas where keterangan ='" & TextBox2.Text & "'"
